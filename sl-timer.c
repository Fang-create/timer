/*
 * @Author: your name
 * @Date: 2020-09-06 14:56:58
 * @LastEditTime: 2020-09-07 22:11:21
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /test-timer/sl-timer.c
 */
#include <stdio.h>
#include <stdint.h>
#include <unistd.h>
...
void print_cb(zskiplistNode *zn) {
    printf("print test and time = %lu\n", zn->score);
}
